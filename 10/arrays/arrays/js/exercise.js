 ...
 *  Using the variables from questions 2 and 4, write code that would change the src of the 
 first image on a web page to the src stored in q2 and the last image on a web page to the src stored 
 in q4. For extra credit, troubleshoot why the images still don't show up.
 */

 $('img').eq(0).attr('src', q2); /*get all the imgs, only look at hte first one, and update teh 'src' with whatever is in q2*/
 $('img').eg(1).attr('src'), q4);
